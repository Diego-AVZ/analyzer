import { AnalysisResult, CorrelationStats } from './types';
import { LongShortAnalysisResult, LongShortStats } from './longShortAnalyzer';
...
export class ReportGenerator {
  ...
  private printExecutiveSummary(results: LongShortAnalysisResult[]): void {
  ...
  private printDetailedResults(results: LongShortAnalysisResult[]): void {
  ...
  private printFinalRecommendations(results: LongShortAnalysisResult[]): void {
